            ...
            <div className='bg-gradient-to-r from-purple-800 to-purple-950 text-white py-16 text-center mx-2 rounded-xl'>
                ...
                <div className='flex items-center justify-between bg-white rounded text-gray-600 max-w-xl pl-4 mx-4 sm:mx-auto'>
                    ...
                    <div className='flex items-center flex-1 border-l border-gray-200'>
                        <img className='h-4 sm:h-5 ml-2' src={assets.location_icon} alt='' />
                        <input
                            type='text'
                    ...
                    <button onClick={onSearch} className='bg-blue-600 hover:bg-blue-700 transition-colors px-6 py-2 rounded text-white m-1'>
                        Search
                    </button>
                </div>
            </div>
